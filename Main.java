...
/** Main class. Sets up the background */
public class Main extends PApplet {
    ...
    private void playerMoved(){
        ...
        if (direction == 39) {
            s.setX(10); //Means snake move from left to right by 10 pixel
            s.setOldX();
            s.setOldY();
        }
        ...
        if (direction == 37) {
            s.setX(-10); //Means snake move right to left by 10pixels
            s.setOldX();
            s.setOldY();
        }
        ...
        if (direction == 38) {
            s.setY(-10); //Means snake move from down to up by 10 pixel
            s.setOldX();
            s.setOldY();
        }
        ...
        if (direction == 40) {
            s.setY(10); //Means snake move from left to right by 10 pixel
            s.setOldX();
            s.setOldY();
        }
    }
